...
class Message
{
    public:
        ...
        enum class TypeM { CONNECT, CONNECT_NEW, CONNACK, PUBLISH, SUBSCRIBE, UNSUBSCRIBE, DISCONNECT };
...
class ConnectMsgNew:public Message
{
    public:
        ConnectMsgNew(int byte);
        Message* clone() const {return new ConnectMsgNew(this->count);};
